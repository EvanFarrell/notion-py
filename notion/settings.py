...
# DATA_DIR = os.environ.get("NOTION_DATA_DIR", str(Path(os.path.expanduser("~/tmp")).joinpath(".notion-py")))
# DATA_DIR = 'http://notion-py-logs.s3.amazonaws.com'
DATA_DIR = os.environ.get("NOTION_DATA_DIR", str(Path("/tmp/").joinpath(".notion-py")))
